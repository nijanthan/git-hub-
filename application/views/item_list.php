...
if($count!=0){
      if($_SESSION['admin']==2){?><table >
        ...
        </td> <td style="width: 150;margin-left: 150px"><?php if($b_row->item_active==0){ ?><a href="<?php echo base_url() ?>index.php/items/to_deactivate_item/<?php echo $erow->id ?>">Deactivate</a> <?php } else{ ?><a href="<?php echo base_url() ?>index.php/items/to_activate_item/<?php echo $erow->id ?>"> Activate</a> <?php } ?></td>
