...
foreach ($depa as $row) {
   foreach ($all_depa as $drow){ 
    ...
    <tr><td><input type="checkbox" name="mycheck[]" value="<?php echo $drow->id ?>" /><?php  echo $drow->dep_name ;	 ?></td><td><a href="<?php echo base_url() ?>index.php/departmentCI/edit_department/<?php echo $drow->id ?>"><?php echo $this->lang->line('edit')?></a></td><td><a href="<?php echo base_url() ?>index.php/departmentCI/department_delete/<?php echo $drow->id?>"><?php echo $this->lang->line('delete')?></a></td><td ><a href=""><?php echo $this->lang->line('edit_permission')?></a></td></tr>
<?php }}}}?>
