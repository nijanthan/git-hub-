<?php
 if($_SESSION['Supplier_per']['edit']==1){
     ...
     echo "<tr><td>"; echo form_label($this->lang->line('taxable'));echo "</td><td>";?> <input type="checkbox" name="taxable" <?php if($c_row->taxable==1){?> checked="checked" <?php } ?> > <?php echo "</td></tr>";
