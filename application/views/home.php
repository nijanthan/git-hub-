...
<table><tr><td style="width: 200"><?php echo form_label($this->lang->line('pos_users')) ?></td><td><?php echo form_label($this->lang->line('item')) ?></td><td><?php if($_SESSION['Setting']['Depart']==1){ echo form_label($this->lang->line('user_groups')); }?></td><td><?php if($_SESSION['Setting']['Branch']==1)  { echo form_label($this->lang->line('branch')); }?></td>
        <td><?php echo form_label($this->lang->line('sales')) ?></td><td><?php echo form_label($this->lang->line('Suppliers')) ?></td><td><?php echo form_label($this->lang->line('customers')) ?></td><td><?php echo form_label($this->lang->line('receiving_item')) ?></td></tr>
    ...
    <td><?php echo form_submit('sales',$this->lang->line('sales'))?></td><td><?php echo form_submit('suppliers',$this->lang->line('Suppliers'))?></td><td><?php echo form_submit('customers',$this->lang->line('customers'))?></td><td><?php echo form_submit('Receiving',$this->lang->line('receiving_item')) ?></td><td><?php echo form_submit('Gifts','Gifts') ?></td></tr>
