...
<table >
    ...
    <tr><td><input type="checkbox" name="mycheck[]" value="<?php echo $erow->id ?>" /><td style="width: 100px"><?php echo $erow->first_name; ?>
        ...
        <td style="width: 100px"><a href="<?php echo base_url() ?>index.php/employees/edit_employee_details/<?php echo $erow->id ?>">Edit</a><td><td style="width: 100px"><a href="<?php echo base_url() ?>index.php/employees/edit_employee_permission/<?php echo $erow->id ?>">Edit permission</a></td>
